...
#         vol = Vol(date_depart=v_date_deparresponse =amadeus.shopping.flight_offers_search.get(
#         originLocationCode='MAD',
#         destinationLocationCode='ADQ',
#         departureDate='2023-06-01',
#         adults=1,
#         max=20)t,date_arrivee=v_date_arrivee,prix=v_prix,nombre_place=v_nombre_place)
